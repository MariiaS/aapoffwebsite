...
import 'newsletter_subscription_model.dart';
export 'newsletter_subscription_model.dart';

class NewsletterSubscriptionWidget extends StatefulWidget {
  const NewsletterSubscriptionWidget({Key? key}) : super(key: key);

  @override
  _NewsletterSubscriptionWidgetState createState() =>
      _NewsletterSubscriptionWidgetState();
}

class _NewsletterSubscriptionWidgetState
    extends State<NewsletterSubscriptionWidget> {
  late NewsletterSubscriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewsletterSubscriptionModel());
